...
public class MapData {
     ...
     */
    public GameMap mapWithLevel(int level) {
    ...
    private void initMapData() {
        GameMap map1 = new GameMap(tankPos1, brickPos1, stonePos1, waterPos1, grassPos1, homePos1, playerPos1);
        GameMap map2 = new GameMap(tankPos2, brickPos2, stonePos2, waterPos2, grassPos2, homePos2, playerPos2);
        GameMap map3 = new GameMap(tankPos3, brickPos3, stonePos3, waterPos3, grassPos3, homePos3, playerPos3);
        maps.add(map1);
        maps.add(map2);
        maps.add(map3);
    }
